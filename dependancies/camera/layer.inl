...
inline Camera2D::Layer::Layer(const std::string& path, float scrollMultiplier, int sections, bool locked)
...
inline void Camera2D::Layer::init(bool scrollX, SDL_Renderer * renderer, const SDL_Rect& bounds)
{
	m_scrollX = scrollX;
...
inline void Camera2D::Layer::draw(SDL_Renderer* target) const
{
...
inline void Camera2D::Layer::update(const Vector2& vel, const SDL_Rect& bounds, const Vector2& shakeOffset)
{
...
inline void Camera2D::Layer::setScrollMultiplier(float scrollMultiplier)
{
	m_scrollMultiplier = scrollMultiplier;
}

inline float Camera2D::Layer::getScrollMultiplier() const
{
	return m_scrollMultiplier;
}

inline int Camera2D::Layer::clamp(int value, int min, int max)
{
	if (value < 0)
	{
		return max - 1;
...
inline void Camera2D::Layer::positionSection(const SDL_Rect& bounds, int section, int xDir, int yDir)
{
...
inline SDL_Texture * Camera2D::Layer::loadTexture(const std::string & path, SDL_Renderer* renderer)
{

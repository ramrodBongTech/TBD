...
inline bool Game::initialize(const char* title, int width, int height, int flags)
{
	srand(time(NULL));
...
inline SDL_Texture * Game::loadTexture(const std::string & path)
{
